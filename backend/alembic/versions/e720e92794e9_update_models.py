...
def upgrade() -> None:
    ...
    op.add_column('recipe', sa.Column('slug', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('recipe', sa.Column('gousto_uid', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
